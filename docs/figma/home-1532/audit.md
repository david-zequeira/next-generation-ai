# Auditoría Home · Figma 1532:2424 vs código
...
|---|---|---|---|---|
| Orden de secciones | 01 Header → 02 Hero → 03 El futuro → 04 Servicios → 05 Cómo trabajamos → 06 Proceso → 07 Tecnología → 08 Pruebas no promesas → 09 Calculadora → 10 Planes 2026 → 11 Hablemos → 12 Footer | src/app/page.tsx:59-68 | pendiente | |
...
## 09 · Calculadora → `src/components/sections/Roi.tsx`
...
## 10 · Planes 2026 → `src/components/sections/Plans.tsx`
...
## 11 · Hablemos → `src/components/sections/FinalCTA.tsx`
