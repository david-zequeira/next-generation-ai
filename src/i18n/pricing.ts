...
const es: PricingDict = {
  ...
  plans: [
    ...
    },
    {
      ...
      quota: ["1.000 conversaciones/mes", "Web bilingüe ES/EN", "SEO incluido", "Agente en 2 idiomas", "1 sede", "2 h/mes de cambios"],
  ...
  compare: {
    ...
    sub: "El Starter y el Core montan exactamente el mismo asistente. La diferencia es que el Core además te construye la marca y la web, y trabaja para que te encuentren: en Google y en los buscadores con IA.",
  ...
  addons: {
    ...
    items: [
      ...
      { name: "Integración con tus sistemas", desc: "Tu POS, ERP, CRM o software de facturación se estudia y se presupuesta en el Diagnóstico: cada sistema es un mundo y no vendemos conectores que no existen.", price: "a presupuestar" },
...
const en: PricingDict = {
  ...
  plans: [
    ...
    },
    {
      ...
      quota: ["1,000 conversations/mo", "Bilingual website EN/ES", "SEO included", "Agent in 2 languages", "1 location", "2 h/mo of changes"],
  ...
  compare: {
    ...
    sub: "Starter and Core run exactly the same assistant. The difference is that Core also builds your brand and website, and works to get you found: on Google and in AI search.",
    cols: ["Starter", "Core", "Nexus"],
    rows: [
  ...
  addons: {
    ...
    items: [
      ...
      { name: "Integration with your systems", desc: "Your POS, ERP, CRM or invoicing software gets assessed and quoted in the Diagnostic. We don't sell connectors that don't exist.", price: "quoted" },
