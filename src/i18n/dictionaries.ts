...
const en = {
  ...
  finalCta: {
    ...
    note: "projects@asenix.es · Response within 2 hours",
  },
  roi: {
  ...
  contact: {
    ...
    sub: "One short message is enough. A real person replies within 2 working hours — no automated sales sequences.",
    nameLabel: "Your name",
    namePh: "Ana García",
    ...
    successText: "We'll get back to you within 2 working hours. Meanwhile, you can ask our AI assistant anything.",
...
const es: typeof en = {
  ...
  finalCta: {
    ...
    note: "projects@asenix.es · Respuesta en menos de 2 h",
  },
  roi: {
    eyebrow: "La cuenta",
  ...
  contact: {
    ...
    titleB: "tu negocio.",
    sub: "Con un mensaje corto basta. Te responde una persona real en menos de 2 horas laborables — sin secuencias comerciales automáticas.",
    nameLabel: "Tu nombre",
    namePh: "Ana García",
    ...
    successText: "Te contactamos en menos de 2 horas laborables. Mientras tanto, puedes preguntarle lo que quieras a nuestro asistente de IA.",
