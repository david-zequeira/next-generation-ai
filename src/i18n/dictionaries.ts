...
const en = {
  ...
  finalCta: {
    ...
    note: "projects@asenix.es · Reply within 1 business day",
  },
  roi: {
  ...
  contact: {
    ...
    sub: "One short message is enough. A real person replies within 1 business day — no automated sales sequences.",
    nameLabel: "Your name",
    namePh: "Ana García",
    ...
    successText: "We'll get back to you within 1 business day. Meanwhile, you can ask our AI assistant anything.",
...
const es: typeof en = {
  ...
  finalCta: {
    ...
    note: "projects@asenix.es · Respuesta en 24 h laborables",
  },
  roi: {
    eyebrow: "La cuenta",
  ...
  contact: {
    ...
    titleB: "tu negocio.",
    sub: "Con un mensaje corto basta. Te responde una persona real en menos de 24 h laborables — sin secuencias comerciales automáticas.",
    nameLabel: "Tu nombre",
    namePh: "Ana García",
    ...
    successText: "Te contactamos en menos de 24 h laborables. Mientras tanto, puedes preguntarle lo que quieras a nuestro asistente de IA.",
