...
const es: CalcDict = {
  ...
  form: {
    ...
    planHint: "El Arranque monta el asistente sobre la web que ya tienes. El Core añade la web nueva y su posicionamiento, y por eso cuesta 100 € más al mes.",
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: "El **Arranque** está atendiendo en tu web y tu WhatsApp en **7 días**, porque se monta sobre la web que ya tienes. El **Core** son **2 semanas**, que es lo que lleva construir la marca y la web nuevas, y cuesta 100 € más al mes por esa web.",
      },
    ],
  },
  diag: {
    badge: "El siguiente paso, si te cuadra",
    body: "Esto es una cuenta de servilleta hecha con cifras que has puesto a ojo. El **Diagnóstico de IA** es la versión medida: 48 horas mirando tus procesos de verdad, con las oportunidades ordenadas por retorno y las cifras sacadas de tu negocio en lugar de una hipótesis. **Y no te cuesta nada** — el informe es tuyo, lo contrates o no.",
...
const en: CalcDict = {
  ...
  form: {
    ...
    planHint: "Arranque puts the assistant on the website you already have. Core adds the new website and its ranking, which is why it costs €100 more per month.",
  ...
  lead: {
    ...
    sending: "Sending…",
    okTitle: "Got it",
    okBody: "You'll have the breakdown with your figures within 1 business day. If you'd rather move faster, reply to that same email and we'll look at it sooner.",
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: "**Arranque** is answering on your website and WhatsApp in **7 days**, because it sits on the site you already have. **Core** takes **2 weeks**, which is what building the new brand and website takes, and it costs €100 more per month for that website.",
      },
    ],
  },
  diag: {
    badge: "The next step, if it adds up",
    body: "This is a back-of-the-napkin calculation from figures you estimated. The **AI Diagnostic** is the measured version: 48 hours looking at your actual processes, with the opportunities ranked by return and the figures taken from your business rather than from an assumption. **And it costs you nothing** — the report is yours, whether you sign up or not.",
