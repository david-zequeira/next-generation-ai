...
const es: CalcDict = {
  ...
  lead: {
    ...
    sending: "Enviando…",
    okTitle: "Recibido",
    okBody: "Te llega el desglose con tus cifras en menos de 2 h laborables. Si prefieres adelantarlo, respóndenos al mismo correo y lo vemos antes.",
...
const en: CalcDict = {
  ...
  lead: {
    ...
    sending: "Sending…",
    okTitle: "Got it",
    okBody: "You'll have the breakdown with your figures within 2 working hours. If you'd rather move faster, reply to that same email and we'll look at it sooner.",
